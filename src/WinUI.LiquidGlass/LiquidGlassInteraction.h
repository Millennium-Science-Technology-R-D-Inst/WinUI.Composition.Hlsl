...
#define LIQUID_GLASS_INTERACTION_DOUBLE(Name) \
    ...
    public:
        ...
        LIQUID_GLASS_INTERACTION_BOOL(RespectSystemAnimations)
        ...
        LIQUID_GLASS_INTERACTION_DOUBLE(PointerOverDispersionMultiplier)
        LIQUID_GLASS_INTERACTION_DOUBLE(PointerOverSaturationMultiplier)
        LIQUID_GLASS_INTERACTION_DOUBLE(PointerOverContrastMultiplier)
        LIQUID_GLASS_INTERACTION_DOUBLE(PointerOverExposureBoost)
        LIQUID_GLASS_INTERACTION_DOUBLE(PointerOverTintBoost)
        LIQUID_GLASS_INTERACTION_DOUBLE(PointerOverHighlightMultiplier)
        LIQUID_GLASS_INTERACTION_DOUBLE(PointerOverHighlightBoost)
        LIQUID_GLASS_INTERACTION_DOUBLE(PointerOverInnerShadowBoost)
