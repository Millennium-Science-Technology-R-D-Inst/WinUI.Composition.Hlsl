...
namespace winrt::WinUI::Composition::Hlsl::implementation
{
	Hlsl::HlslRuntimeCapabilities HlslComposition::GetRuntimeCapabilities()
	{
		...
		return make<HlslRuntimeCapabilities>(
			...
			true,  // NativeAdapterAvailable
			true,  // SupportsCompositionGraphNodes
			true,  // SupportsMaterializedGraphs
			true,  // SupportsLinkedMultiSource
			false, // SupportsMaterializedMultiSource
			false, // SupportsMultipleCustomNodes
			false, // SupportsNativeNodesAfterCustom
			true,  // SupportsVectorProperties
			true); // SupportsMatrixProperties
	...
	Hlsl::HlslEffectFactory HlslComposition::CreateEffectFactory(
	...
	Hlsl::HlslEffectBrush HlslComposition::CreateBackdropBrush(
		Microsoft::UI::Composition::Compositor const& compositor,
		Hlsl::HlslEffect const& effect)
	{
	...
	Microsoft::UI::Xaml::Media::Brush HlslComposition::CreateXamlBrushFromCompositionBrush(
		Microsoft::UI::Composition::CompositionBrush const& brush)
	{
		if (!brush) throw hresult_invalid_argument();
