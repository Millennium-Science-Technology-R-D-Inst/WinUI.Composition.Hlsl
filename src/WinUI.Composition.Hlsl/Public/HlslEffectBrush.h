...
namespace winrt::WinUI::Composition::Hlsl::implementation
{
	...
	{
		HlslEffectBrush(Microsoft::UI::Composition::CompositionEffectBrush const& brush, std::shared_ptr<hlsl::engine::EffectDefinition const> definition) :m_brush(brush), m_definition(std::move(definition))
		{
		}
