...
| `HeaderTemplate` | `DataTemplate` | Dependency property forwarded to inherited `ContentTemplate`. |
| `OnContent` | `Object` | Content displayed while the switch is checked. |
| `OnContentTemplate` | `DataTemplate` | Template for `OnContent`. |
| `OffContent` | `Object` | Content displayed while the switch is unchecked. |
| `OffContentTemplate` | `DataTemplate` | Template for `OffContent`. |
